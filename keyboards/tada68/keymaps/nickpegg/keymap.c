...
[_FL] = LAYOUT_ansi(
  ...
  _______,_______, KC_UP,_______,_______, _______,_______,_______,_______,_______,_______,KC_BRID,KC_BRIU, _______,KC_HOME, \
  _______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,_______,_______,_______,_______,_______,        _______,KC_END, \
  _______,_______,BL_BRTG,BL_DEC, BL_TOGG,BL_INC, _______,_______,KC_VOLD,KC_VOLU,KC_MUTE,_______, KC_PGUP, _______, \
